...
public class AEntityField {
     ...
     */
    public AEntityField(Field field, PropertyDescriptor propertyDescriptor) {
        if (field != null) {
            this.field = field;
     ...
     * @param other
     */
    public void copyFromPropertyDescriptor(AEntityField other) {
    ...
    public boolean equals(Object o) {
        ...
        AEntityField that = (AEntityField) o;
